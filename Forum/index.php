                        ...
                        <li class="dropdown tasks-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <!-- inner menu: contains the actual data -->
                                    <ul class="menu">
                                        <li ng-repeat="item in UserQuestions" class="persian-rtl link">
                                            ...
                                            <h5>
                                                <span ng-show="item.QuestionUserFollow != null" class="description col-xs-3">
                                                    {{item.QuestionUserFollow}}
                                                    <i class="fa fa-users" aria-hidden="true"></i>
                                                </span>
                                                <span ng-show="item.questionView != null" class="description col-xs-3">
                                                    {{item.questionView}}
                                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                                </span>
                                                <span ng-show="item.questionAnswers != null" class="description col-xs-3">
                                                    {{item.questionAnswers}}
                                                    <i class="fa fa-home" aria-hidden="true"></i>
                                                </span>
                                                <span ng-show="item.QuestionRate != null" class="description col-xs-3">
                                                    {{item.QuestionRate}}
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    ...
                    <div class="pull-left info">
                        <p>
                            <a ui-sref="profile" ng-bind="user.FullName"></a>
                        </p>
                        <a>
                            آنلاین
                            <i class="fa fa-circle text-green"></i>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li id="SForum" class="treeview">
                        ...
                        fa-circle-o"></i>
                            ...
                            <li id="SDataSwitch">
                                <a ui-sref="main_forum({id:'DataSwitch'})">
                                    <i class="fa fa-circle-o"></i>
                                    مراکز خودکار و دیتا سوئیچ
                                </a>
                            </li>
                            <li id="SRadio">
                                <a ui-sref="main_forum({id:'Radio'})">
                                    <i class="fa fa-circle-o"></i>
                                    رادیوئی
                                </a>
                            </li>
                            ...
                            <li id="SCommonTopics">
                                <a ui-sref="main_forum({id:'CommonTopics'})">
                                    <i class="fa fa-circle-o"></i>
                                    مباحث مشترک
                                </a>
                            </li>
