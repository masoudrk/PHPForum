angular.module(appName).directive('autoPaging', function () {
    ...
    function setScopeValues(scope, attrs) {
        ...
        scope.textTitlePage = scope.textTitlePage || 'صفحه {page}';
        scope.textTitleFirst = scope.textTitleFirst || 'صفحه اول';
        scope.textTitleLast = scope.textTitleLast || 'صفحه آخر';
        scope.textTitleNext = scope.textTitleNext || 'صفحه بعد';
        scope.textTitlePrev = scope.textTitlePrev || 'صفحه قبل';
