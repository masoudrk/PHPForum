    ...
    grunt.initConfig({
        ...
        uglify: {
            angular: {
                options: {
                    ...
                    'Build/Forum/ng-vendor.min.js': ['angular/user/min/ng-vendor.js'],
            ...
            jsfiles: {
                ...
                files: {
                    'Build/cms/js/page-script.min.js': ['javascript/jQuery-2.1.4.min.js', 'javascript/jquery-ui.min.js', 'javascript/bootstrap.min.js'
                        ...
                        , 'javascript/textAngular.min.js', 'javascript/ng-csv.js'
                    ]
                }
            ...
            app: {
                files: {
                    ...
                    'angular/user/min-safe/annontate.js': ['angular/user/forum-app.js', 'angular/user/partials/**/*.js'/*, 'angular/admin/directives/*.js' */],
        ...
        concat: {
            ...
            basic_and_extras: {
                files: {
                    ...
                    'angular/user/min/ng-vendor.js': ['angular/user/min-safe/annontate.js'],
        ...
        ngtemplates: {
            ...
            forumApp: {
                ...
                files: {
                    'Build/Forum/templates.min.js': ['angular/user/**/**.html']
                }
            },
            myApp: {
                options: {
            ...
            target: {
                files: {
                    'Build/css/page-style.min.css': [
                        ...
                        , 'styles/ng-img-crop.min.css', 'styles/anim-in-out.css', 'styles/select.css'
