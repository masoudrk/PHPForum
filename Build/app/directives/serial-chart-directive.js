            ...
            $scope.$watch('chartData', function (oval, nval) {
                ...
                $timeout(function () {
                    ...
                    var opt = {
                        ...
                        categoryField: $scope.categoryField ? $scope.categoryField : 'date',
                    ...
                    $scope.chart = AmCharts.makeChart($scope.chartId,
                        {
                            ...
                            "startDuration": 1,
                            "graphs": $scope.chartGraphs,
                            categoryField: $scope.categoryField ? $scope.categoryField : 'OrganizationName',
                            "categoryAxis": {
                                "gridPosition": "start",
                                "gridAlpha": 0.2,
                                "axisAlpha": 0,
...
angular.module('am-charts').directive('cylinderChart', function () {
    return {
        restrict: 'ECA',
        scope: {
            chartData: '=',
                    ...
                    $scope.chart = AmCharts.makeChart($scope.chartId,
                        {
                            ...
                            "valueAxes": [{
                                ...
                                labelFunction: function (item) {
                                    return persianJs((item).toString()).englishNumber().toString();
                                }
                            }],
                            "graphs": $scope.chartGraphs,
                            "depth3D": 40,
                            ...
                            "chartCursor": {
                                ...
                                "cursorAlpha": 0,
                                "zoomable": false,
                                categoryBalloonFunction: function formatLabel(value, valueString, axis) {
                                    var date = moment(valueString);
                                    var d = date.format('jYY/jMM/jDD');
                                    return persianJs(d).englishNumber().toString();
                                }
                            },
                            categoryField: $scope.categoryField ? $scope.categoryField : 'category',
                            "categoryAxis": {
                                "gridPosition": "start",
                                parseDates: true,
                                "axisAlpha": 0,
...
angular.module('am-charts').directive('columnChart', function () {
    return {
        restrict: 'ECA',
        scope: {
            chartData: '=',
